        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPointsEarned = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillOfferedId = table.Column<Guid>(type: "uuid", nullable: false),
                    SkillRequestedId = table.Column<Guid>(type: "uuid", nullable: false),
                    Type = table.Column<string>(type: "text", nullable: false),
                    Duration = table.Column<int>(type: "integer", nullable: true),
                    PointsValue = table.Column<int>(type: "integer", nullable: true),
                    RequesterMessage = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exchanges_Skills_SkillRequestedId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointPerHour = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score = table.Column<int>(type: "integer", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_SkillOfferedId",
                table: "Exchanges",
                column: "SkillOfferedId");

            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_SkillRequestedId",
                table: "Exchanges",
