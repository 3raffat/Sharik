...
namespace Sharik.Application.Featuers.Exchanges.Dtos
{
    ...
    public sealed record ProviderExchangeDto(string requesteName , string SkillOffered , string SkillRequested , string ExchangeStatue , string type , string? requesterMessage , int? duration , int? pointsValue);
