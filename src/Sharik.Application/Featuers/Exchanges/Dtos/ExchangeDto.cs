...
namespace Sharik.Application.Featuers.Exchanges.Dtos
{
    ...
    public sealed record UserExchangeDto(Guid exchangeId ,string providerName, string requesteName , string SkillOffered , string SkillRequested , string ExchangeStatue , string type , string? requesterMessage , int? duration , int? pointsValue,string role);
